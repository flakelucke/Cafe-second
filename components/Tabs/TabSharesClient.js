...
export default class TabQRClient extends Component {
   ...
   render() {
    ...
    <ImageBackground
      source={require('/media/flake/28E4941CE493E9F8/Web/Cafe/img/bg_image.png')}
              ...
              <View style = {{ height : 50, backgroundColor: '#FFDC26', padding : 5,flex: 1, flexDirection: 'row', }}>
                  ...
                  <View style = {{ flex : 0.5, alignItems: 'flex-end',}}>
                    <TouchableOpacity onPress={() => this._handlePressHome()} >
                      <Image style = {styles.user} source={require('/media/flake/28E4941CE493E9F8/Web/Cafe/img/user.png')}/>
                    </TouchableOpacity>
                  </View>
